...
int main()
{
	// Read the images : src image will be clone into dst
	Mat src = imread("Seamless Cloning/airplane.jpg");
	cout << src.cols << " " << src.rows << endl;
	Mat dst = imread("Seamless Cloning/sky.jpg");
	...
	// The location of the center of the src in dst
